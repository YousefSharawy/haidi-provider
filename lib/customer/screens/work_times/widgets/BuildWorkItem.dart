...
class BuildWorkItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<GenericBloc<List<WorkTimeModel>>,
        GenericState<List<WorkTimeModel>>>(
      bloc: workTimesData.workTimeBloc,
                  ...
                  Row(
                    children: [
                      Checkbox(
                          ...
                          onChanged: (value) {
                            workTimesData.onSelectClose(index, value);
                          }),
                      MyText(
