...
/// the item is tapped. By default, it uses [sa.aait.heidiProvider] to return the
...
class PopupMenuItemState<T, W extends CustomPopupMenuItem<T>> extends State<W> {
  ...
  ///
  /// By default, uses [sa.aait.heidiProvider] to return the [CustomPopupMenuItem.value] from
  /// the menu route.
  @protected
  void handleTap() {
    // aait.flutter.haidiProvider<T>(context, widget.value);
  }
